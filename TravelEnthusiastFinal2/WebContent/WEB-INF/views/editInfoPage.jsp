...
<table style = "border:1px solid;  margin: 0 auto; text-align:center;">
    <h3 style= "text-align: center; margin-top: 40px;">Edit your info:</h3>
    
       <form action="editFName" method="post">
		<tr>
			<td>${userInfo.firstName}</td>
			<td><input class = "name" type="text" name="fname" placeholder= "enter first name" autofocus/></td>
			<td><input type="submit" value="submit"/></td>
		</tr>
	</form>
	
	
	<form action="editLName" method="post">
		<tr>
	...
	<form action="editEmail" method="post">
		<tr>
			...
			<td><input class = "name" type="submit" value="submit"/></td>
		</tr>
	</form>		
